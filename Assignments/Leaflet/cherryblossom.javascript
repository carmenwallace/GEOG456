var cherryblossom =
    <head>
        ...
        crossorigin=""></script>
        <script src="/FILELOCATION/FILENAME.geojson" ></script>
    </head>
    <body>
    ...
    alert("Change the code: You need to change the address to the GeoJSON. Also you can remove this alert")
    ...
    var uncIcon = L.icon({    // notice the L.icon which is a Leaflet object with properties
        iconUrl: 'https://identity.unc.edu/files/2014/01/Old_Well_Graphic_twitter.jpg',   
